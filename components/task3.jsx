...
const Task3 = ({ taskanswers, setTaskAnswers, step, handleIncrementStep }) => {
    ...
    return (
        <div className='task1'>
            <center><p className='bg-black p-3 w-3/4 bg-opacity-50'>Seems like you have cleared the Previous round -_- Here you go with a <a href="/sources/photos.rar" download>Zip file</a>. Try to solve the Puzzle and Come up witht he flag :)</p></center>
            <input
